...
happyExpList = Happy_Data_Array.listArray (0,67) ([18544,262,0,0,120,0,0,28672,1608,25735,18544,34566,100,0,0,34688,30720,28674,1608,25735,18544,34566,100,0,0,0,0,28672,1608,25735,1920,30721,1,0,25735,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parser","Exp","true","false","num","'+'","and","or","'*'","'('","')'","','","if","then","else","primeiro","segundo","%eof"]
        bit_start = st * 20
        bit_end = (st + 1) * 20
...
action_25 (10) = happyShift action_16
...
action_28 (8) = happyShift action_14
action_28 (9) = happyShift action_15
...
happyNewToken action sts stk (tk:tks) =
	...
	TokenOr -> cont 10;
	TokenMult -> cont 11;
	TokenAParenteses -> cont 12;
	TokenFParenteses -> cont 13;
	TokenVirgula -> cont 14;
	TokenIf -> cont 15;
	TokenThen -> cont 16;
	TokenElse -> cont 17;
	TokenPrimeiro -> cont 18;
	TokenSegundo -> cont 19;
	_ -> happyError' ((tk:tks), [])
	}
